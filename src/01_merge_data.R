...
kwb_2016 <- readRDS("H:/wmo_heterogeneity/data/raw/kwb-2016.rds")
kwb_2017 <- readRDS("H:/wmo_heterogeneity/data/raw/kwb-2017.rds") %>%
  mutate(gm_code = as.numeric(substr(gwb_code_8, 1, 4)))
kwb_2018 <- readRDS("H:/wmo_heterogeneity/data/raw/kwb-2018.rds") %>%
  mutate(gm_code = as.numeric(substr(gwb_code_8, 1, 4)))
...
load("H:/wmo_heterogeneity/data/edit/cw_bu_gem_2019.rda")
...
## Save resultant set
saveRDS(full, "H:/wmo_heterogeneity/data/edit/full_df_2016_2019.rds")
